...
import { addProduct, getLength } from '../../../http/parser/kvtAPI'
                ...
                await addProduct(formData, i, quantity)
                    ...
                    .then(data => {
                        if (data?.error) {
                            ...
                            // mess += "<br />" + i + ": " + data.url + " - " + data.price + "р."
                            // setMessage(i + ": " + data.url + " - " + data.price + "р.")
                            // console.log(i + ": " + data.url + " - " + data.price + "р.")
                            mess += "<br />" + data.map(i => i + "<br />").join("")//JSON.stringify(data)
                            setMessage(data.map(i => i + "<br />").join(""))//JSON.stringify(data))
                            console.log(data.map(i => i + "<br />").join(""))//JSON.stringify(data))
                        }
                    })
                    // eslint-disable-next-line
                    .catch(error => {
