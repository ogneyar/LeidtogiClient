    ...
    return (
        <InfoPage>
            <div className="DeliveryPages">
                ...
                <p>Вы можете самостоятельно получить свой товар на складе компании в городе Курск, а так же в городе Москва. Адреса и график работы Вы можете посмотреть в разделе <NavLink to={CONTACTS_ROUTE}>«Контакты»</NavLink>.</p>
